...
howManyvs = (tupleText.count('v'))
print(f"{howManyvs} is the amount of lowercase V's in this long paragraph")
howManycapVs = (tupleText.count('V'))
print(f"{howManycapVs} is the amount of capital V's in this long paragraph")
total_vs = howManycapVs + howManyvs
...
# Output the result
print(f"So the amount of lowercase V's in the text is {howManyvs} and the amount of capital V's is {howManycapVs}. Overall, the amount of every single V's appearance is {total_vs}")
